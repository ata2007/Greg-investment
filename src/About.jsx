...
function About() {
  ...
  useEffect(() => {
    setTimeout(() => setFadeIn(true), 100); // slight delay for effect
  }, []);
  ...
  return (
    ...
    >
      <main className="flex-1 w-full flex flex-col items-center justify-center">
        <section
          id="about"
          className={`relative w-full max-w-5xl mx-auto py-20 px-6 text-center flex flex-col items-center justify-center transition-all duration-1000 ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-12 font-medium drop-shadow-lg">
              At <span className="font-bold text-cyan-200">Greg Investments</span>, we are committed to helping you secure your financial future.<br />
              With decades of experience and a proven track record, we provide expert guidance and innovative solutions tailored to meet your financial goals.
            </p>
            <div className="grid gap-8 sm:grid-cols-3">
              <div className="bg-gradient-to-br from-blue-100/80 to-cyan-100/80 rounded-2xl shadow-xl p-8 border-t-4 border-cyan-400 hover:scale-105 transition-transform duration-300">
              ...
              <div className="bg-gradient-to-br from-cyan-100/80 to-blue-100/80 rounded-2xl shadow-xl p-8 border-t-4 border-blue-400 hover:scale-105 transition-transform duration-300">
                <h2 className="text-2xl font-bold text-cyan-700 mb-3">Our Vision</h2>
                <p className="text-blue-900 font-medium">
                  To be the leading provider of trusted financial services worldwide.
                </p>
              </div>
              <div className="bg-gradient-to-br from-blue-200/80 to-cyan-200/80 rounded-2xl shadow-xl p-8 border-t-4 border-cyan-600 hover:scale-105 transition-transform duration-300">
